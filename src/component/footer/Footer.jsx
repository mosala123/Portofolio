      ...
      <div className="container d-flex flex-column flex-md-row justify-content-between align-items-center">
        ...
        <div className="text-center text-md-end">
          ...
          <div className="d-flex justify-content-center justify-content-md-end gap-3 fs-4 mt-2">
            <Link
              to="/https://github.com/mosala123"
              className="text-light footer"
            >
              <FaGithub />
            </Link>
            <Link
              to="/https://www.linkedin.com/in/mohamed-ibrahim-1a6a9131b"
              className="text-light footer"
            >
              <FaLinkedin />
            </Link>
            <Link to="/Portofolio" className="text-light footer">
              <FaFacebookSquare />
            </Link>
          </div>
        </div>
